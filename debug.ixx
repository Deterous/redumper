...
export int redumper_debug(Context &ctx, Options &options)
{
    ...
    if(1)
    {
        ...
        LOG("0:");
        scrambler.descramble(sector.data(), 0x030010, DATA_FRAME_SIZE, 0x0);
        LOG("  calc EDC: {:X}", DVD_EDC().update(sector.data(), offsetof(DataFrame, edc)).final());
        write_vector("descrambled0.sector", sector);
        LOG("1:");
        scrambler.descramble(copy1.data(), 0x030010, DATA_FRAME_SIZE, 0x1);
        LOG("  calc EDC: {:X}", DVD_EDC().update(copy1.data(), offsetof(DataFrame, edc)).final());
        write_vector("descrambled1.sector", copy1);
        LOG("2:");
        scrambler.descramble(copy2.data(), 0x030010, DATA_FRAME_SIZE, 0x2);
        LOG("  calc EDC: {:X}", DVD_EDC().update(copy2.data(), offsetof(DataFrame, edc)).final());
        write_vector("descrambled2.sector", copy2);
        LOG("3:");
        scrambler.descramble(copy3.data(), 0x030010, DATA_FRAME_SIZE, 0x3);
        LOG("  calc EDC: {:X}", DVD_EDC().update(copy3.data(), offsetof(DataFrame, edc)).final());
        write_vector("descrambled3.sector", copy3);
        LOG("4:");
        scrambler.descramble(copy4.data(), 0x030010, DATA_FRAME_SIZE, 0x4);
        LOG("  calc EDC: {:X}", DVD_EDC().update(copy4.data(), offsetof(DataFrame, edc)).final());
        write_vector("descrambled4.sector", copy4);
        LOG("5:");
        scrambler.descramble(copy5.data(), 0x030010, DATA_FRAME_SIZE, 0x5);
        LOG("  calc EDC: {:X}", DVD_EDC().update(copy5.data(), offsetof(DataFrame, edc)).final());
        write_vector("descrambled5.sector", copy5);
        LOG("6:");
        scrambler.descramble(copy6.data(), 0x030010, DATA_FRAME_SIZE, 0x6);
        LOG("  calc EDC: {:X}", DVD_EDC().update(copy6.data(), offsetof(DataFrame, edc)).final());
        write_vector("descrambled6.sector", copy6);
        LOG("7:");
        scrambler.descramble(copy7.data(), 0x030010, DATA_FRAME_SIZE, 0x7);
        LOG("  calc EDC: {:X}", DVD_EDC().update(copy7.data(), offsetof(DataFrame, edc)).final());
        write_vector("descrambled7.sector", copy7);
        LOG("8:");
        scrambler.descramble(copy8.data(), 0x030010, DATA_FRAME_SIZE, 0x8);
        LOG("  calc EDC: {:X}", DVD_EDC().update(copy8.data(), offsetof(DataFrame, edc)).final());
        write_vector("descrambled8.sector", copy8);
        LOG("9:");
        scrambler.descramble(copy9.data(), 0x030010, DATA_FRAME_SIZE, 0x9);
        LOG("  calc EDC: {:X}", DVD_EDC().update(copy9.data(), offsetof(DataFrame, edc)).final());
        write_vector("descrambled9.sector", copy9);
        LOG("A:");
        scrambler.descramble(copya.data(), 0x030010, DATA_FRAME_SIZE, 0xA);
        LOG("  calc EDC: {:X}", DVD_EDC().update(copya.data(), offsetof(DataFrame, edc)).final());
        write_vector("descrambleda.sector", copya);
        LOG("B:");
        scrambler.descramble(copyb.data(), 0x030010, DATA_FRAME_SIZE, 0xB);
        LOG("  calc EDC: {:X}", DVD_EDC().update(copyb.data(), offsetof(DataFrame, edc)).final());
        write_vector("descrambledb.sector", copyb);
        LOG("C:");
        scrambler.descramble(copyc.data(), 0x030010, DATA_FRAME_SIZE, 0xC);
        LOG("  calc EDC: {:X}", DVD_EDC().update(copyc.data(), offsetof(DataFrame, edc)).final());
        write_vector("descrambledc.sector", copyc);
        LOG("D:");
        scrambler.descramble(copyd.data(), 0x030010, DATA_FRAME_SIZE, 0xD);
        LOG("  calc EDC: {:X}", DVD_EDC().update(copyd.data(), offsetof(DataFrame, edc)).final());
        write_vector("descrambledd.sector", copyd);
        LOG("E:");
        scrambler.descramble(copye.data(), 0x030010, DATA_FRAME_SIZE, 0xE);
        LOG("  calc EDC: {:X}", DVD_EDC().update(copye.data(), offsetof(DataFrame, edc)).final());
        write_vector("descramblede.sector", copye);
        LOG("F:");
        scrambler.descramble(copyf.data(), 0x030010, DATA_FRAME_SIZE, 0xF);
        LOG("  calc EDC: {:X}", DVD_EDC().update(copyf.data(), offsetof(DataFrame, edc)).final());
        write_vector("descrambledf.sector", copyf);
    }
